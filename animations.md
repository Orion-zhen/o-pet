...
| `playful` | 进入后 6–10 s 可首次旋转，之后每 3.5–6 s 再旋转 |
...
| `happy` | 身体轻快弹动，眼睛放大并保持开放视线，表现稳定而温和的开心。 |
...
| `proud` | 身体抬高并稳定舒展，视线略向上，像在安静欣赏刚完成的成果。 |
...
| `playful` | 身体轻跳、摇摆并偶尔旋转，表现正在主动邀请下一次互动。 |
...
| `front` | 收起自主扫视并正面看向用户，表达“现在你是我的注意中心”。 |
