...
(function (global) {
  ...
  const RADIUS = {
    dots: 22, orbit: 19, radar: 19, gather: 19, wave: 16,
  ...
  const { clamp, rand, Rc, y1e, K2 } = global.GROK_MATH;
  ...
  class OverlayLayer {
    ...
    paintGather(ze, now, R) {
      const mt = Rc(ze), Dt = CYCLE_ON.gather;
  ...
  global.GROK_EFFECTS = Object.freeze({
    CYCLE,
    CYCLE_ON,
    CYCLE_OFF,
