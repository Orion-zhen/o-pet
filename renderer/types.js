...
/** @typedef {{ finishNativeDrag(): void, setPreferences(preferences: RendererPreferences): void, showAction(name: string): void, update(update: RendererUpdate): boolean }} RendererClientApi */
